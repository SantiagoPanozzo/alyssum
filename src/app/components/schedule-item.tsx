...
export default function ScheduleItem({ time, title, speaker, location }: ScheduleItemProps) {
  return (
    <div className="flex flex-col md:flex-row gap-4 p-4 rounded-lg border border-slate-300 bg-background hover:bg-muted/50 shadow-lg transition duration-300 ease-in-out hover:scale-102 hover:shadow-lg hover:shadow-sky-200 ">
